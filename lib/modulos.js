...
const MODULOS = [
  ...
  { id: 'fiscal', nome: 'Fiscal', paginas: ['fiscal'], apis: ['fiscal'] },
  ...
  { id: 'processos', nome: 'Processos', paginas: ['pendencias', 'negativos', 'log'], apis: ['pendencias', 'negativos', 'log-erp', 'contagem'] },
];
