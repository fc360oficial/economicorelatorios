...
const MODULOS = [
  ...
  { id: 'compras', nome: 'Gestão de Compras',
    paginas: ['centro-distribuicao', 'cotacao', 'fiscal', 'ruptura', 'fornecedores', 'pedidos-compra', 'ponta-gondola', 'radar-pedidos',
              'sugestao-compras', 'painel-cd', 'comprador', 'analise-comprador', 'margem-comprador', 'compras', 'mensal', 'relatorio-cronograma'],
    apis: ['compras', 'cotacoes', 'fiscal', 'ruptura', 'fornecedores', 'listas-compra', 'pedidos-cd', 'painel-cd', 'pedidos-fornecedor',
