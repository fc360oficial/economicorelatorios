...
function salvarSnapshot() {
  ...
  // pra comparar depois produto a produto com o que a comprador(a) pediu no ERP
  const itens = {};
  for (const r of rows) {
...
module.exports = { init, agendar, recalcular, recarregarEmbPadrao, calcularHist12, politica, itensLista, curvaARisco, projetarLoja, lojasSet, sombra, sombraDetalhe, nfe, atualizarHistEmSegundoPlano, getEstado, curvaASet, TETO_PADRAO,
