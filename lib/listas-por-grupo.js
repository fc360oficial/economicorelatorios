...
//
// Hoje cada lista de compra do ERP (central.c_cotacao_lista) é de um fornecedor e tem um(a) comprador(a)
...
function csv(resultado) {
  ...
  const linhas = [['Comprador(a)', 'Grupos do(a) comprador(a)', 'Nº lista', 'Lista (nome sugerido)', 'Fornecedor', 'Comprador(a) hoje', 'Itens do grupo', 'Itens da lista', '%', 'Situação'].join(';')];
