...
// pdfkit ainda não está instalado no servidor (.254) — a geração do modelo
// de contrato fica pra quando o Tiago rodar `npm install` por lá. Até lá,
// NÃO reative o require('pdfkit') aqui nem o require('multer') no
// server.js, senão o processo crasha ao subir por módulo ausente.
...
// DESATIVADO por enquanto: depende do pdfkit, que ainda não foi instalado
// no servidor. Reativar junto com o require('pdfkit') no topo do arquivo
// e os endpoints de contrato em server.js.
//
...
module.exports = { LOJAS, QTD_INICIAL, carregarPontas, salvarPontas, calcularStatus, comPlano, CONTRATOS_DIR };
