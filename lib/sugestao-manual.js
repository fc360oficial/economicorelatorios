...
let q = null, mesDB = null, transitoDe = () => 0, curvaASet = () => null;
function initERP(deps) { q = deps.q; mesDB = deps.mesDB; transitoDe = deps.transitoDe || (() => 0); curvaASet = deps.curvaASet || (() => null); }
...
module.exports = { DIR, _setDir, init, proximoId, salvar, obter, listar, aplicarPatch, calcularLoja, repartirPorLoja, initERP, montarDeLinhas, montarDoERP, montarItens, mesesDoPeriodo, calcularNova, recalcular };
