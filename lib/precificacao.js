...
const CENARIOS_TESTE = [
  { loja: 1, pedidoId: 9001, lista_nome: 'TESTE · MASSAS VITARELLA', fornecedor: 'VITARELLA (TESTE)', frete: 30, ipi: 0, st: 0, itens: [
    ['7896213000011', 'MACARRÃO ESPAGUETE 500G (curva A, custo subiu)', true, 3.10, 3.45, 28, 3.99],
    ['7896213000028', 'MACARRÃO PARAFUSO 500G (curva A, custo caiu)', true, 3.20, 2.95, 28, 4.19],
    ['7896213000035', 'BISCOITO CREAM CRACKER 400G (custo caiu)', false, 3.80, 3.40, 32, 5.29],
    ['7896213000042', 'BISCOITO MARIA 400G (sem mudança)', false, 3.60, 3.58, 32, 4.99],
    ['7896213000059', 'FARINHA DE TRIGO 1KG (abaixo do custo hoje)', false, 4.20, 4.60, 20, 4.49]
  ] },
  { loja: 2, pedidoId: 9002, lista_nome: 'TESTE · CAFÉ TRÊS CORAÇÕES', fornecedor: 'TRÊS CORAÇÕES (TESTE)', frete: 45, ipi: 0, st: 80, itens: [
    ['7896005800010', 'CAFÉ EXTRA FORTE 500G (curva A, subiu 12%)', true, 14.20, 15.90, 22, 17.99],
    ['7896005800027', 'CAFÉ TRADICIONAL 500G (curva A, subiu 9%)', true, 13.10, 14.30, 22, 16.49],
    ['7896005800034', 'CAFÉ SOLÚVEL 200G (sem margem cadastrada)', false, 12.40, 13.10, null, 15.99],
    ['7896005800041', 'CAPPUCCINO 200G (produto novo na loja)', false, null, 9.80, 35, null]
  ] },
  { loja: 3, pedidoId: 9003, lista_nome: 'TESTE · LIMPEZA YPÊ', fornecedor: 'YPÊ (TESTE)', frete: 15, ipi: 6, st: 12, itens: [
    ['7896098900017', 'DETERGENTE 500ML (curva A, custo caiu)', true, 2.05, 1.85, 40, 2.89],
    ['7896098900024', 'AMACIANTE 2L (custo caiu)', false, 8.90, 7.95, 38, 12.49],
    ['7896098900031', 'SABÃO EM PÓ 1KG (custo caiu)', false, 9.10, 8.40, 30, 11.99],
    ['7896098900048', 'DESINFETANTE 2L (sem mudança)', false, 6.20, 6.22, 42, 8.79],
    ['7896098900055', 'ESPONJA 3UN (subiu)', false, 2.30, 2.75, 55, 3.59]
  ] },
  { loja: 4, pedidoId: 9004, lista_nome: 'TESTE · ARROZ E FEIJÃO', fornecedor: 'FORNECEDOR TESTE', frete: 20, ipi: 0, st: 28, atacado: true, itens: [
    ['7891000100103', 'ARROZ TIPO 1 5KG (curva A, custo subiu)', true, 22.90, 24.50, 18, 27.99, 12, 26.49],
    ['7891000100110', 'FEIJÃO CARIOCA 1KG (curva A, custo caiu)', true, 7.80, 6.90, 25, 9.99, 15, 9.29],
    ['7891000100127', 'BISCOITO 400G (não é A, custo caiu)', false, 4.10, 3.60, 35, 5.69, 20, 5.19],
    ['7891000100134', 'DETERGENTE 500ML (sem mudança)', false, 1.90, 1.83, 40, 2.69, null, null],
    ['7891000100141', 'SABÃO EM PÓ 1KG (sem margem cadastrada)', false, 8.20, 8.90, null, 11.49, null, null],
    ['7891000100158', 'AZEITE 500ML (produto novo na loja)', false, null, 24.00, 30, null, null, null]
  ] },
  { loja: 5, pedidoId: 9005, lista_nome: 'TESTE · BEBIDAS AMBEV', fornecedor: 'AMBEV (TESTE)', semRateio: true, itens: [
    ['7891991000017', 'CERVEJA LATA 350ML (curva A, subiu)', true, 2.85, 3.05, 25, 3.69],
    ['7891991000024', 'REFRIGERANTE 2L (curva A, caiu)', true, 5.40, 5.05, 30, 7.29],
    ['7891991000031', 'ÁGUA 500ML (sem mudança)', false, 0.95, 0.96, 60, 1.59],
...
function gerarPdf(r) {
  ...
  doc.fontSize(8.5).fillColor('#C9D1E3').text(`Pedido #${r.pedidoId} · ${r.lista_nome} · ${r.fornecedor} · conciliado ${dt(r.conciliadoEm)} · regra ${r.parametros.politica} · terminação ${r.parametros.arredondamento}`, 40, 76, { width: W - 24 });
  let y = 104;
  const l4 = r.loja === 4;
