...
const CENARIOS_TESTE = [
  ...
  { loja: 1, pedidoId: 9001, lista_nome: 'TESTE · MASSAS VITARELLA', fornecedor: 'VITARELLA (TESTE)', frete: 30, ipi: 0, st: 0, itens: [
    ...
    ['7896213000042', 'BISCOITO MARIA 400G (−6%, menos de 20% → mantém)', false, 3.60, 3.40, 32, 4.99],
  ...
  { loja: 2, pedidoId: 9002, lista_nome: 'TESTE · CAFÉ TRÊS CORAÇÕES', fornecedor: 'TRÊS CORAÇÕES (TESTE)', frete: 45, ipi: 0, st: 80, itens: [
    ...
    ['7896005800027', 'CAFÉ TRADICIONAL 500G (exatamente −20% → preço −10%)', true, 13.10, 10.48, 22, 16.49],
  ...
  { loja: 3, pedidoId: 9003, lista_nome: 'TESTE · LIMPEZA YPÊ', fornecedor: 'YPÊ (TESTE)', frete: 15, ipi: 6, st: 12, itens: [
    ...
    ['7896098900024', 'AMACIANTE 2L (−11%, menos de 20% → mantém)', false, 8.90, 7.95, 38, 12.49],
  ...
  { loja: 4, pedidoId: 9004, lista_nome: 'TESTE · ARROZ E FEIJÃO', fornecedor: 'FORNECEDOR TESTE', frete: 20, ipi: 0, st: 28, atacado: true, itens: [
    ...
    ['7891000100127', 'BISCOITO 400G (−12%, menos de 20% → mantém)', false, 4.10, 3.60, 35, 5.69, 20, 5.19],
...
function gerarPdf(r) {
  ...
  doc.fontSize(8.5).fillColor('#C9D1E3').text(`Pedido #${r.pedidoId} · ${r.lista_nome} · ${r.fornecedor} · conciliado ${dt(r.conciliadoEm)} · regra: custo ≥ atual → margem; 20%+ mais barato → preço −10% · terminação ${r.parametros.arredondamento}`, 40, 76, { width: W - 24 });
  let y = 104;
  const l4 = r.loja === 4;
