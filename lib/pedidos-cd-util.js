...
function casarPorDescricao(descricaoCaixa, unidades, { maxAlternativas = 4 } = {}) {
  ...
  const unico = m && m.cobertura === 1 && m.extra <= 1 && !(s && s.cobertura === 1 && s.extra === m.extra);
  return { candidato: unico ? m.cod : null, alternativas };
}
module.exports = { ean13Valido, dun14ParaEan13, emCaixas, distribuirCdInsuficiente, statusRecebimento, mediaLead, tokensDescricao, casarPorDescricao };
